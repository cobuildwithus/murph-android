...
enum class AuthDiagnosticCode(
    ...
    HostedResponseRejected("hosted_response_rejected", true),
    HostedCredentialsUnavailable("hosted_credentials_unavailable", true),
    HostedInvalidResponse("hosted_invalid_response", true),
