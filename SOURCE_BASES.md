...
The current parity work was prepared against these reviewed source snapshots on August 5, 2026:
...
Account admission and initial onboarding require the listed Murph backend PR to
deploy before this Android change. The mobile client deliberately consumes that
server-owned contract rather than duplicating signup, catalog, or completion
state.
