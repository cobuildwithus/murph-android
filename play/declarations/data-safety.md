...
| Health info — HRV, respiratory rate, and blood oxygen | Only after explicit permission | Junction can upload the authorized variability, breathing-rate, and oxygen-saturation records for the member-authorized wellness context. | Same confirmation required. |
| Health info — body fat, weight, and height | Only after explicit permission | Junction can upload the authorized body-composition and profile measurements for the member-authorized wellness context. | Same confirmation required. |
| Fitness info — VO2 max | Only after explicit permission | Junction can upload the authorized VO2 max records for the member-authorized activity context. | Same confirmation required. |
